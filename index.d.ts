...
export interface ClassicTheme extends Theme {
  palette: {
    neutral: {
      lightest: string
      light: string
  ...
  colors: {
    ...
    tealTint: string
    border: { default: string; muted: string }
    text: { success: string; info: string; danger: string }
    icon: {
      default: string
      muted: string
      disabled: string
  ...
  components: {
    Alert: {
      appearances: {
        card: { boxShadow: string; borderRadius: string }
      }
      sizes: {}
    }
    Avatar: { appearances: {}; sizes: {} }
    ...
    DialogBody: { baseStyle: { padding: string } }
    DialogFooter: {
      baseStyle: { padding: string; borderTop: string }
    }
    DialogHeader: {
      baseStyle: { padding: string; borderBottom: string }
    }
    Group: {
      baseStyle: {
        _child: {
    ...
    Input: {
      baseStyle: {
        ...
        paddingX: number
        _placeholder: { color: string }
        _disabled: { cursor: string }
        _focus: { zIndex: string }
      }
      appearances: {
        default: {
          backgroundColor: string
          _invalid: {}
          _focus: {}
          _disabled: { backgroundColor: string }
        }
        neutral: {
          backgroundColor: string
          _invalid: {}
    ...
    List: { baseStyle: {}; appearances: {}; sizes: {} }
    Link: {
      baseStyle: { _hover: {}; _active: {}; _focus: {} }
      appearances: {}
      sizes: {}
    }
    MenuItem: {
      ...
      appearances: {
        default: {
          ...
          _focus: { backgroundColor: string }
          _active: { backgroundColor: string }
          _current: { backgroundColor: string }
        }
      }
    }
    Option: {
    ...
    Switch: {
      ...
      appearances: {
        default: {
          ...
          _disabled: { opacity: number; backgroundImage: string }
          _hover: { backgroundColor: string }
          _active: { backgroundColor: string }
          _focus: {}
          _checked: { backgroundColor: string; color: string }
    ...
    Table: { baseStyle: {}; appearances: {}; sizes: {} }
    TableCell: {
      baseStyle: { paddingX: number }
      appearances: {
        default: {
