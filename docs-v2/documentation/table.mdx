...
TableHead" rename="Table.Head" />

TableBody" rename="Table.Body" />
...
TextTableCell" rename="Table.TextCell" />
...
TableHeaderCell" rename="Table.HeaderCell" />
...
TextTableHeaderCell" rename="Table.TextHeaderCell" />
...
SearchTableHeaderCell" rename="Table.SearchHeaderCell" />
...
TableVirtualBody" rename="Table.VirtualBody" />
