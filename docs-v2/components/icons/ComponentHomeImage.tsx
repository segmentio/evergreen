...
const ComponentHomeImage = ({ width=120, height=100 }: Props) => {
  return (
    ...
    >
      ...
      <path d="M35.5 42V18C35.5 14.6863 32.8137 12 29.5 12H21" stroke="#C1C4D6" stroke-linecap="square" stroke-linejoin="round" stroke-dasharray="5 5"/>
      ...
      <path d="M87 88.5L63 88.5C59.6863 88.5 57 85.8137 57 82.5L57 65" stroke="#C1C4D6" stroke-linecap="square" stroke-linejoin="round" stroke-dasharray="5 5"/>
