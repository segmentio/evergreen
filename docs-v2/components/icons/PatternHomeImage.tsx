...
const PatternHomeImage = ({ width=120, height=100 }: Props) => {
  return (
    ...
    >
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M17.1837 46.5662C9.71832 43.2734 5.61905 35.191 7.35198 27.1814C9.08492 19.1718 16.1777 13.4181 24.3634 13.3817L24.3626 13.5853C16.2731 13.6213 9.26364 19.3074 7.55107 27.2229C5.8385 35.1383 9.8896 43.1258 17.2672 46.3799L17.1837 46.5662Z" stroke="#C1C4D6"/>
      <path fill-rule="evenodd" clip-rule="evenodd" d="M12.782 79.7791C5.05607 77.1553 0.262182 69.4645 1.28433 61.3336C2.30647 53.2027 8.86605 46.8477 17.0168 46.0919L17.0339 46.2947C8.97892 47.0417 2.49642 53.322 1.48629 61.3573C0.476153 69.3927 5.21371 76.9931 12.8488 79.5861L12.782 79.7791Z" stroke="#C1C4D6"/>
