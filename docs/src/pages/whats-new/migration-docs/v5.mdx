...
### Breaking Changes
 ...
 - [Toggle no longer manages state](#toggle)
...
### Toggle is uncontrolled {#toggle}

To unify usage of form components across Evergreen, we updated Toggle to more closely match other components, such as `Checkbox`.
