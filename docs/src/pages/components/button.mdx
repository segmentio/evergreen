  ...
  {({ state, setState }) => (
    <React.Fragment>
      ...
      <Pane marginTop={12}>
        ...
        <Button size={state.value} marginRight={16} appearance="primary" intent="danger">
          Danger
        </Button>
        <Button size={state.value} marginRight={16} appearance="primary" intent="success" iconBefore={AddIcon}>
          Icon Before
        </Button>
        <Button size={state.value} appearance="primary" iconAfter={ArrowRightIcon}>
          Icon After
        </Button>
      </Pane>
      ...
      <Pane marginTop={12}>
        ...
        <Button size={state.value} marginRight={16} appearance="minimal" intent="danger">
          Danger
        </Button>
        <Button size={state.value} marginRight={16} appearance="minimal" iconBefore={EditIcon}>
          Icon Before
        </Button>
        <Button size={state.value} appearance="minimal" iconAfter={CaretDownIcon}>
          Icon After
        </Button>
      </Pane>
    </React.Fragment>
...
<>
  ...
  <Button marginRight={12} size="small">Height 24</Button>
  <Button marginRight={12} size="medium">Height 32</Button>
  <Button marginRight={12} size="large">Height 40</Button>
...
```jsx
<>
  <Button marginY={8} marginRight={12} iconBefore={CogIcon}>Settings</Button>
  <Button marginY={8} marginRight={12} iconBefore={EditIcon}>Edit</Button>
  <Button marginY={8} marginRight={12} iconBefore={ManualIcon}>Docs</Button>
  <Button marginY={8} marginRight={12} iconBefore={ArrowLeftIcon}>Back</Button>
  <Button marginY={8} marginRight={12} iconBefore={DownloadIcon}>Download...</Button>
  <Button marginY={8} marginRight={12} iconBefore={TrashIcon} intent="danger">Delete...</Button>
  <Button marginY={8} marginRight={12} iconBefore={SearchIcon}>Search</Button>
  <Button marginY={8} marginRight={12} iconAfter={CaretDownIcon}>Filter</Button>
</>
```
