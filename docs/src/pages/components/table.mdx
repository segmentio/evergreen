...
The source code of this example is availble in `docs/src/components/examples/AdvancedTable` on [GitHub](https://github.com/segmentio/evergreen).
...
* Row heights can be unknown up front with `height="auto"`, this will reduce perfomance however

### Simple virtuall body example
...
The source code of this example is availble in `docs/src/components/examples/VirtualTable` on [GitHub](https://github.com/segmentio/evergreen).
This example features dynaminc and auto heights.
