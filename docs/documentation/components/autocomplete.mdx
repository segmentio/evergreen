# Usage
The Autocomplete components renders a filterable list of options in a [Popover](./popover.mdx) — it does not render the text input.
If you need a combination with a text input and trigger button, take a look at the [Combobox](./combobox.mdx) component.
...
>
  {({
    ...
    <Pane ref={getRef} display="inline-block">
      <TextInput
...
Note that this is very similar to the [Combobox](./combobox.mdx) component. 
