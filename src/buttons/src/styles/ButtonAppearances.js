...
ButtonAppearances.default = Themer.createButtonAppearance({
  disabled,
  base: {
...
ButtonAppearances.blue = Themer.createButtonAppearance({
  disabled,
  base: {
...
ButtonAppearances.green = Themer.createButtonAppearance({
  disabled,
  base: {
...
ButtonAppearances.red = Themer.createButtonAppearance({
  disabled,
  base: {
    backgroundColor: colors.green['500'],
    color: 'white',
...
ButtonAppearances.ghostBlue = Themer.createButtonAppearance({
  disabled,
  base: {
