...
export type TableCellProps<T extends React.ElementType<any> = 'div'> = PolymorphicBoxProps<T, TableCellOwnProps>
...
const _TableCell = <T extends React.ElementType<any> = 'div'>(
...
const TableCell = memoizeWithForwardedRef(_TableCell)
