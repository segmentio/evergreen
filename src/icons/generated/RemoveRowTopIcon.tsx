...
export const RemoveRowTopIcon: IconComponent = memo(
  forwardRef(function RemoveRowTopIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="remove-row-top" {...props} />
  })
)
