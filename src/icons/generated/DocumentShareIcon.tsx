...
export const DocumentShareIcon: IconComponent = memo(
  forwardRef(function DocumentShareIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="document-share" {...props} />
  })
)
