...
export const BriefcaseIcon: IconComponent = memo(
  forwardRef(function BriefcaseIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="briefcase" {...props} />
  })
)
