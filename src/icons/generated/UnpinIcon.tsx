...
export const UnpinIcon: IconComponent = memo(
  forwardRef(function UnpinIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="unpin" {...props} />
  })
)
