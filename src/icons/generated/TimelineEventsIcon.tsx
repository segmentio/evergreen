...
export const TimelineEventsIcon: IconComponent = memo(
  forwardRef(function TimelineEventsIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="timeline-events" {...props} />
  })
)
