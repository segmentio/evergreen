...
export const OutdatedIcon: IconComponent = memo(
  forwardRef(function OutdatedIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="outdated" {...props} />
  })
)
