...
export const TrendingUpIcon: IconComponent = memo(
  forwardRef(function TrendingUpIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="trending-up" {...props} />
  })
)
