...
export const SearchTextIcon: IconComponent = memo(
  forwardRef(function SearchTextIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="search-text" {...props} />
  })
)
