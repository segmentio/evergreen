...
export const MobileVideoIcon: IconComponent = memo(
  forwardRef(function MobileVideoIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="mobile-video" {...props} />
  })
)
