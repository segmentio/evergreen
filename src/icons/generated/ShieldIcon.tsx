...
export const ShieldIcon: IconComponent = memo(
  forwardRef(function ShieldIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="shield" {...props} />
  })
)
