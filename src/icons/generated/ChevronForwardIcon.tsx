...
export const ChevronForwardIcon: IconComponent = memo(
  forwardRef(function ChevronForwardIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="chevron-forward" {...props} />
  })
)
