...
export const CaretUpIcon: IconComponent = memo(
  forwardRef(function CaretUpIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="caret-up" {...props} />
  })
)
