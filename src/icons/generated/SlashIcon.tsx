...
export const SlashIcon: IconComponent = memo(
  forwardRef(function SlashIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="slash" {...props} />
  })
)
