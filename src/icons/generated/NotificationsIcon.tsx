...
export const NotificationsIcon: IconComponent = memo(
  forwardRef(function NotificationsIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="notifications" {...props} />
  })
)
