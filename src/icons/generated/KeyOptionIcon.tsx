...
export const KeyOptionIcon: IconComponent = memo(
  forwardRef(function KeyOptionIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="key-option" {...props} />
  })
)
