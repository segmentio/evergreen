...
export const SeriesSearchIcon: IconComponent = memo(
  forwardRef(function SeriesSearchIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="series-search" {...props} />
  })
)
