...
export const MountainIcon: IconComponent = memo(
  forwardRef(function MountainIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="mountain" {...props} />
  })
)
