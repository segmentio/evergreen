...
export const BringDataIcon: IconComponent = memo(
  forwardRef(function BringDataIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="bring-data" {...props} />
  })
)
