...
export const CaretRightIcon: IconComponent = memo(
  forwardRef(function CaretRightIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="caret-right" {...props} />
  })
)
