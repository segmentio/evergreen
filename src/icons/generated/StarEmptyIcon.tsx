...
export const StarEmptyIcon: IconComponent = memo(
  forwardRef(function StarEmptyIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="star-empty" {...props} />
  })
)
