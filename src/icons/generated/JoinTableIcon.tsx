...
export const JoinTableIcon: IconComponent = memo(
  forwardRef(function JoinTableIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="join-table" {...props} />
  })
)
