...
export const VolumeOffIcon: IconComponent = memo(
  forwardRef(function VolumeOffIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="volume-off" {...props} />
  })
)
