...
export const ShopIcon: IconComponent = memo(
  forwardRef(function ShopIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="shop" {...props} />
  })
)
