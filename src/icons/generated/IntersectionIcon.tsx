...
export const IntersectionIcon: IconComponent = memo(
  forwardRef(function IntersectionIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="intersection" {...props} />
  })
)
