...
export const SendToIcon: IconComponent = memo(
  forwardRef(function SendToIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="send-to" {...props} />
  })
)
