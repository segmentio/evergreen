...
export const ColumnLayoutIcon: IconComponent = memo(
  forwardRef(function ColumnLayoutIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="column-layout" {...props} />
  })
)
