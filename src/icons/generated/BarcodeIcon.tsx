...
export const BarcodeIcon: IconComponent = memo(
  forwardRef(function BarcodeIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="barcode" {...props} />
  })
)
