...
export const RightJoinIcon: IconComponent = memo(
  forwardRef(function RightJoinIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="right-join" {...props} />
  })
)
