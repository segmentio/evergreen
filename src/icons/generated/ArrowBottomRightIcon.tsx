...
export const ArrowBottomRightIcon: IconComponent = memo(
  forwardRef(function ArrowBottomRightIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="arrow-bottom-right" {...props} />
  })
)
