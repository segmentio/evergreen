...
export const LayerIcon: IconComponent = memo(
  forwardRef(function LayerIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="layer" {...props} />
  })
)
