...
export const EraserIcon: IconComponent = memo(
  forwardRef(function EraserIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="eraser" {...props} />
  })
)
