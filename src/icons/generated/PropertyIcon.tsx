...
export const PropertyIcon: IconComponent = memo(
  forwardRef(function PropertyIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="property" {...props} />
  })
)
