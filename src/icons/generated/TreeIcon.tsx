...
export const TreeIcon: IconComponent = memo(
  forwardRef(function TreeIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="tree" {...props} />
  })
)
