...
export const AddColumnRightIcon: IconComponent = memo(
  forwardRef(function AddColumnRightIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="add-column-right" {...props} />
  })
)
