...
export const FastBackwardIcon: IconComponent = memo(
  forwardRef(function FastBackwardIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="fast-backward" {...props} />
  })
)
