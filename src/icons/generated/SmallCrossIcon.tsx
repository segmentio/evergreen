...
export const SmallCrossIcon: IconComponent = memo(
  forwardRef(function SmallCrossIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="small-cross" {...props} />
  })
)
