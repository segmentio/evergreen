...
export const SimCardIcon: IconComponent = memo(
  forwardRef(function SimCardIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="sim-card" {...props} />
  })
)
