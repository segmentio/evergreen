...
export const HeatmapIcon: IconComponent = memo(
  forwardRef(function HeatmapIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="heatmap" {...props} />
  })
)
