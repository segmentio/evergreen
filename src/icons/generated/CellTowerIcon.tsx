...
export const CellTowerIcon: IconComponent = memo(
  forwardRef(function CellTowerIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="cell-tower" {...props} />
  })
)
