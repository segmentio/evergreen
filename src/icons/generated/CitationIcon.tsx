...
export const CitationIcon: IconComponent = memo(
  forwardRef(function CitationIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="citation" {...props} />
  })
)
