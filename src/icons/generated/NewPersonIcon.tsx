...
export const NewPersonIcon: IconComponent = memo(
  forwardRef(function NewPersonIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="new-person" {...props} />
  })
)
