...
export const OneColumnIcon: IconComponent = memo(
  forwardRef(function OneColumnIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="one-column" {...props} />
  })
)
