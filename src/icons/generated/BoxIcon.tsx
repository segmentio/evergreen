...
export const BoxIcon: IconComponent = memo(
  forwardRef(function BoxIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="box" {...props} />
  })
)
