...
export const SearchTemplateIcon: IconComponent = memo(
  forwardRef(function SearchTemplateIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="search-template" {...props} />
  })
)
