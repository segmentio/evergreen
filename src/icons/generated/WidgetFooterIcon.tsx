...
export const WidgetFooterIcon: IconComponent = memo(
  forwardRef(function WidgetFooterIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="widget-footer" {...props} />
  })
)
