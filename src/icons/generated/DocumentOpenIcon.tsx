...
export const DocumentOpenIcon: IconComponent = memo(
  forwardRef(function DocumentOpenIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="document-open" {...props} />
  })
)
