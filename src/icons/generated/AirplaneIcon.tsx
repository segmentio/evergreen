...
export const AirplaneIcon: IconComponent = memo(
  forwardRef(function AirplaneIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="airplane" {...props} />
  })
)
