...
export const DisableIcon: IconComponent = memo(
  forwardRef(function DisableIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="disable" {...props} />
  })
)
