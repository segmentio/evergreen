...
export const CameraIcon: IconComponent = memo(
  forwardRef(function CameraIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="camera" {...props} />
  })
)
