...
export const KeyCommandIcon: IconComponent = memo(
  forwardRef(function KeyCommandIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="key-command" {...props} />
  })
)
