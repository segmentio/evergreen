...
export const ConsoleIcon: IconComponent = memo(
  forwardRef(function ConsoleIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="console" {...props} />
  })
)
