...
export const FlowEndIcon: IconComponent = memo(
  forwardRef(function FlowEndIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="flow-end" {...props} />
  })
)
