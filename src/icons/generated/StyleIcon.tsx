...
export const StyleIcon: IconComponent = memo(
  forwardRef(function StyleIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="style" {...props} />
  })
)
