...
export const MenuClosedIcon: IconComponent = memo(
  forwardRef(function MenuClosedIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="menu-closed" {...props} />
  })
)
