...
export const FolderCloseIcon: IconComponent = memo(
  forwardRef(function FolderCloseIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="folder-close" {...props} />
  })
)
