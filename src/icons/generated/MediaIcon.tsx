...
export const MediaIcon: IconComponent = memo(
  forwardRef(function MediaIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="media" {...props} />
  })
)
