...
export const SmallTickIcon: IconComponent = memo(
  forwardRef(function SmallTickIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="small-tick" {...props} />
  })
)
