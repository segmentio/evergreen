...
export const GanttChartIcon: IconComponent = memo(
  forwardRef(function GanttChartIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="gantt-chart" {...props} />
  })
)
