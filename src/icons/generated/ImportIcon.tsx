...
export const ImportIcon: IconComponent = memo(
  forwardRef(function ImportIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="import" {...props} />
  })
)
