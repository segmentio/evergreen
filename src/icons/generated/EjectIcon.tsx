...
export const EjectIcon: IconComponent = memo(
  forwardRef(function EjectIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="eject" {...props} />
  })
)
