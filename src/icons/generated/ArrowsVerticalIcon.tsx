...
export const ArrowsVerticalIcon: IconComponent = memo(
  forwardRef(function ArrowsVerticalIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="arrows-vertical" {...props} />
  })
)
