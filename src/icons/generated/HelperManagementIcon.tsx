...
export const HelperManagementIcon: IconComponent = memo(
  forwardRef(function HelperManagementIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="helper-management" {...props} />
  })
)
