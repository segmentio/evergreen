...
export const MaximizeIcon: IconComponent = memo(
  forwardRef(function MaximizeIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="maximize" {...props} />
  })
)
