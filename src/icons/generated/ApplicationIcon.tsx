...
export const ApplicationIcon: IconComponent = memo(
  forwardRef(function ApplicationIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="application" {...props} />
  })
)
