...
export const ThIcon: IconComponent = memo(
  forwardRef(function ThIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="th" {...props} />
  })
)
