...
export const RigIcon: IconComponent = memo(
  forwardRef(function RigIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="rig" {...props} />
  })
)
