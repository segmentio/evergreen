...
export const ExchangeIcon: IconComponent = memo(
  forwardRef(function ExchangeIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="exchange" {...props} />
  })
)
