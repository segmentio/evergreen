...
export const FolderOpenIcon: IconComponent = memo(
  forwardRef(function FolderOpenIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="folder-open" {...props} />
  })
)
