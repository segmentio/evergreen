...
export const TimeIcon: IconComponent = memo(
  forwardRef(function TimeIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="time" {...props} />
  })
)
