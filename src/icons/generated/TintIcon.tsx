...
export const TintIcon: IconComponent = memo(
  forwardRef(function TintIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="tint" {...props} />
  })
)
