...
export const GitRepoIcon: IconComponent = memo(
  forwardRef(function GitRepoIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="git-repo" {...props} />
  })
)
