...
export const GroupObjectsIcon: IconComponent = memo(
  forwardRef(function GroupObjectsIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="group-objects" {...props} />
  })
)
