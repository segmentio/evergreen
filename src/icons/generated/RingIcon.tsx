...
export const RingIcon: IconComponent = memo(
  forwardRef(function RingIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ring" {...props} />
  })
)
