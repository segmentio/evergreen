...
export const CollapseAllIcon: IconComponent = memo(
  forwardRef(function CollapseAllIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="collapse-all" {...props} />
  })
)
