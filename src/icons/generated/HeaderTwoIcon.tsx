...
export const HeaderTwoIcon: IconComponent = memo(
  forwardRef(function HeaderTwoIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="header-two" {...props} />
  })
)
