...
export const CircleArrowDownIcon: IconComponent = memo(
  forwardRef(function CircleArrowDownIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="circle-arrow-down" {...props} />
  })
)
