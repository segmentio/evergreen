...
export const AlignmentLeftIcon: IconComponent = memo(
  forwardRef(function AlignmentLeftIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="alignment-left" {...props} />
  })
)
