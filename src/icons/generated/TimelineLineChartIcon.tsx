...
export const TimelineLineChartIcon: IconComponent = memo(
  forwardRef(function TimelineLineChartIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="timeline-line-chart" {...props} />
  })
)
