...
export const MusicIcon: IconComponent = memo(
  forwardRef(function MusicIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="music" {...props} />
  })
)
