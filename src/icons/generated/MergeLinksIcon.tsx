...
export const MergeLinksIcon: IconComponent = memo(
  forwardRef(function MergeLinksIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="merge-links" {...props} />
  })
)
