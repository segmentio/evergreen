...
export const CubeRemoveIcon: IconComponent = memo(
  forwardRef(function CubeRemoveIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="cube-remove" {...props} />
  })
)
