...
export const PathIcon: IconComponent = memo(
  forwardRef(function PathIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="path" {...props} />
  })
)
