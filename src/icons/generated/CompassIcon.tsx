...
export const CompassIcon: IconComponent = memo(
  forwardRef(function CompassIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="compass" {...props} />
  })
)
