...
export const GitCommitIcon: IconComponent = memo(
  forwardRef(function GitCommitIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="git-commit" {...props} />
  })
)
