...
export const RotatePageIcon: IconComponent = memo(
  forwardRef(function RotatePageIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="rotate-page" {...props} />
  })
)
