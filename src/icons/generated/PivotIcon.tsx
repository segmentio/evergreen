...
export const PivotIcon: IconComponent = memo(
  forwardRef(function PivotIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="pivot" {...props} />
  })
)
