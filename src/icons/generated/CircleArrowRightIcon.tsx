...
export const CircleArrowRightIcon: IconComponent = memo(
  forwardRef(function CircleArrowRightIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="circle-arrow-right" {...props} />
  })
)
