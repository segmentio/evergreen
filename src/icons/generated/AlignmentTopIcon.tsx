...
export const AlignmentTopIcon: IconComponent = memo(
  forwardRef(function AlignmentTopIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="alignment-top" {...props} />
  })
)
