...
export const ResolveIcon: IconComponent = memo(
  forwardRef(function ResolveIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="resolve" {...props} />
  })
)
