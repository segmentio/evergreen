...
export const SwapHorizontalIcon: IconComponent = memo(
  forwardRef(function SwapHorizontalIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="swap-horizontal" {...props} />
  })
)
