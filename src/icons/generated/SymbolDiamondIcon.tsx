...
export const SymbolDiamondIcon: IconComponent = memo(
  forwardRef(function SymbolDiamondIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="symbol-diamond" {...props} />
  })
)
