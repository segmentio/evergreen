...
export const ArrowBottomLeftIcon: IconComponent = memo(
  forwardRef(function ArrowBottomLeftIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="arrow-bottom-left" {...props} />
  })
)
