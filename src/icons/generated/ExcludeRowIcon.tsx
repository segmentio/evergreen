...
export const ExcludeRowIcon: IconComponent = memo(
  forwardRef(function ExcludeRowIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="exclude-row" {...props} />
  })
)
