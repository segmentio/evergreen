...
export const FilmIcon: IconComponent = memo(
  forwardRef(function FilmIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="film" {...props} />
  })
)
