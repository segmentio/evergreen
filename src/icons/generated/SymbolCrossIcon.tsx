...
export const SymbolCrossIcon: IconComponent = memo(
  forwardRef(function SymbolCrossIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="symbol-cross" {...props} />
  })
)
