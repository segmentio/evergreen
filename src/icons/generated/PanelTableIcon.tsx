...
export const PanelTableIcon: IconComponent = memo(
  forwardRef(function PanelTableIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="panel-table" {...props} />
  })
)
