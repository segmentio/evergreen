...
export const ConfirmIcon: IconComponent = memo(
  forwardRef(function ConfirmIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="confirm" {...props} />
  })
)
