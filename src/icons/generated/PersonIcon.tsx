...
export const PersonIcon: IconComponent = memo(
  forwardRef(function PersonIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="person" {...props} />
  })
)
