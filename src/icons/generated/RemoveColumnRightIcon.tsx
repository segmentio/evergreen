...
export const RemoveColumnRightIcon: IconComponent = memo(
  forwardRef(function RemoveColumnRightIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="remove-column-right" {...props} />
  })
)
