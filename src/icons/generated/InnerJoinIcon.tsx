...
export const InnerJoinIcon: IconComponent = memo(
  forwardRef(function InnerJoinIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="inner-join" {...props} />
  })
)
