...
export const ControlIcon: IconComponent = memo(
  forwardRef(function ControlIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="control" {...props} />
  })
)
