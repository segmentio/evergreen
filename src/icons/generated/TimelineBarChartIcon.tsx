...
export const TimelineBarChartIcon: IconComponent = memo(
  forwardRef(function TimelineBarChartIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="timeline-bar-chart" {...props} />
  })
)
