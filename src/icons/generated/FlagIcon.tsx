...
export const FlagIcon: IconComponent = memo(
  forwardRef(function FlagIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="flag" {...props} />
  })
)
