...
export const TwoColumnsIcon: IconComponent = memo(
  forwardRef(function TwoColumnsIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="two-columns" {...props} />
  })
)
