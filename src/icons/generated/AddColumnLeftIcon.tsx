...
export const AddColumnLeftIcon: IconComponent = memo(
  forwardRef(function AddColumnLeftIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="add-column-left" {...props} />
  })
)
