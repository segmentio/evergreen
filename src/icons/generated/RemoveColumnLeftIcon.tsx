...
export const RemoveColumnLeftIcon: IconComponent = memo(
  forwardRef(function RemoveColumnLeftIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="remove-column-left" {...props} />
  })
)
