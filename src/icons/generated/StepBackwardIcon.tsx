...
export const StepBackwardIcon: IconComponent = memo(
  forwardRef(function StepBackwardIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="step-backward" {...props} />
  })
)
