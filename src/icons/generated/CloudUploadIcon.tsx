...
export const CloudUploadIcon: IconComponent = memo(
  forwardRef(function CloudUploadIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="cloud-upload" {...props} />
  })
)
