...
export const HeatGridIcon: IconComponent = memo(
  forwardRef(function HeatGridIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="heat-grid" {...props} />
  })
)
