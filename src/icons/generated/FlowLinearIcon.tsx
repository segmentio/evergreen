...
export const FlowLinearIcon: IconComponent = memo(
  forwardRef(function FlowLinearIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="flow-linear" {...props} />
  })
)
