...
export const SmallPlusIcon: IconComponent = memo(
  forwardRef(function SmallPlusIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="small-plus" {...props} />
  })
)
