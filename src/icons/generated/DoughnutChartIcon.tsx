...
export const DoughnutChartIcon: IconComponent = memo(
  forwardRef(function DoughnutChartIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="doughnut-chart" {...props} />
  })
)
