...
export const ChatIcon: IconComponent = memo(
  forwardRef(function ChatIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="chat" {...props} />
  })
)
