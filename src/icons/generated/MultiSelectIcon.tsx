...
export const MultiSelectIcon: IconComponent = memo(
  forwardRef(function MultiSelectIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="multi-select" {...props} />
  })
)
