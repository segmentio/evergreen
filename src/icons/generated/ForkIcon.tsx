...
export const ForkIcon: IconComponent = memo(
  forwardRef(function ForkIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="fork" {...props} />
  })
)
