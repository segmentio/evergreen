...
export const FlameIcon: IconComponent = memo(
  forwardRef(function FlameIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="flame" {...props} />
  })
)
