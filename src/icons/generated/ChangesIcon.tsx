...
export const ChangesIcon: IconComponent = memo(
  forwardRef(function ChangesIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="changes" {...props} />
  })
)
