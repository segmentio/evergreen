...
export const ParagraphIcon: IconComponent = memo(
  forwardRef(function ParagraphIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="paragraph" {...props} />
  })
)
