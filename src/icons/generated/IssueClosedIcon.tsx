...
export const IssueClosedIcon: IconComponent = memo(
  forwardRef(function IssueClosedIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="issue-closed" {...props} />
  })
)
