...
export const HeaderOneIcon: IconComponent = memo(
  forwardRef(function HeaderOneIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="header-one" {...props} />
  })
)
