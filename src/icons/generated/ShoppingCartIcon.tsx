...
export const ShoppingCartIcon: IconComponent = memo(
  forwardRef(function ShoppingCartIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="shopping-cart" {...props} />
  })
)
