...
export const BuildIcon: IconComponent = memo(
  forwardRef(function BuildIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="build" {...props} />
  })
)
