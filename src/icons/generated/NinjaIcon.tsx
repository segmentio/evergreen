...
export const NinjaIcon: IconComponent = memo(
  forwardRef(function NinjaIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ninja" {...props} />
  })
)
