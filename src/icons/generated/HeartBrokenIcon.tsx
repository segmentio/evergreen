...
export const HeartBrokenIcon: IconComponent = memo(
  forwardRef(function HeartBrokenIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="heart-broken" {...props} />
  })
)
