...
export const IpAddressIcon: IconComponent = memo(
  forwardRef(function IpAddressIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ip-address" {...props} />
  })
)
