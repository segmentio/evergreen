...
export const GraphIcon: IconComponent = memo(
  forwardRef(function GraphIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="graph" {...props} />
  })
)
