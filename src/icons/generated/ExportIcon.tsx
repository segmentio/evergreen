...
export const ExportIcon: IconComponent = memo(
  forwardRef(function ExportIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="export" {...props} />
  })
)
