...
export const HandUpIcon: IconComponent = memo(
  forwardRef(function HandUpIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="hand-up" {...props} />
  })
)
