...
export const AddRowTopIcon: IconComponent = memo(
  forwardRef(function AddRowTopIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="add-row-top" {...props} />
  })
)
