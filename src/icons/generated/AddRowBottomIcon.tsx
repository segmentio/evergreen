...
export const AddRowBottomIcon: IconComponent = memo(
  forwardRef(function AddRowBottomIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="add-row-bottom" {...props} />
  })
)
