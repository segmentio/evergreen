...
export const UngroupObjectsIcon: IconComponent = memo(
  forwardRef(function UngroupObjectsIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="ungroup-objects" {...props} />
  })
)
