...
export const CloudIcon: IconComponent = memo(
  forwardRef(function CloudIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="cloud" {...props} />
  })
)
