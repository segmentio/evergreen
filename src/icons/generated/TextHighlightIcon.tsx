...
export const TextHighlightIcon: IconComponent = memo(
  forwardRef(function TextHighlightIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="text-highlight" {...props} />
  })
)
