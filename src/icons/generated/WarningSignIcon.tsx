...
export const WarningSignIcon: IconComponent = memo(
  forwardRef(function WarningSignIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="warning-sign" {...props} />
  })
)
