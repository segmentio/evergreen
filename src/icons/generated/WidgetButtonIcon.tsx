...
export const WidgetButtonIcon: IconComponent = memo(
  forwardRef(function WidgetButtonIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="widget-button" {...props} />
  })
)
