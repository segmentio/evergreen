...
export const BadgeIcon: IconComponent = memo(
  forwardRef(function BadgeIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="badge" {...props} />
  })
)
