...
export const PageLayoutIcon: IconComponent = memo(
  forwardRef(function PageLayoutIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="page-layout" {...props} />
  })
)
