...
export const ArrowTopLeftIcon: IconComponent = memo(
  forwardRef(function ArrowTopLeftIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="arrow-top-left" {...props} />
  })
)
