...
export const ZoomOutIcon: IconComponent = memo(
  forwardRef(function ZoomOutIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="zoom-out" {...props} />
  })
)
