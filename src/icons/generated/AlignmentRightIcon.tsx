...
export const AlignmentRightIcon: IconComponent = memo(
  forwardRef(function AlignmentRightIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="alignment-right" {...props} />
  })
)
