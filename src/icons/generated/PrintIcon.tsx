...
export const PrintIcon: IconComponent = memo(
  forwardRef(function PrintIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="print" {...props} />
  })
)
