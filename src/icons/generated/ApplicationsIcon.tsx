...
export const ApplicationsIcon: IconComponent = memo(
  forwardRef(function ApplicationsIcon(props, ref) {
    return <Icon svgPaths16={svgPaths16} svgPaths20={svgPaths20} ref={ref} name="applications" {...props} />
  })
)
