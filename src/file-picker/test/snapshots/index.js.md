...
> Snapshot 1
    ...
    >
      ...
      <input
        'aria-invalid'={false}
        className="css-lhf1t2 evergreen-file-picker-text-input ub-fnt-sze_12px ub-f-wght_400 ub-ln-ht_16px ub-ltr-spc_0 ub-color_474d66 ub-fnt-fam_b77syt ub-w_280px ub-h_32px ub-pl_12px ub-pr_12px ub-bblr_4px ub-bbrr_0-important ub-btlr_4px ub-btrr_0-important ub-flx_1 ub-txt-ovrf_ellipsis ub-box-szg_border-box"
        disabled={false}
        onBlur={Function {}}
